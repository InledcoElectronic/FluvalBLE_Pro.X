...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/HagenStripIII_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=src/drv_tmr.c src/drv_pwm.c src/drv_eeprom.c src/drv_eusart.c src/app_key.c src/app_rtc.c src/app_util.c src/app_ble.c src/app_led.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/drv_tmr.p1 ${OBJECTDIR}/src/drv_pwm.p1 ${OBJECTDIR}/src/drv_eeprom.p1 ${OBJECTDIR}/src/drv_eusart.p1 ${OBJECTDIR}/src/app_key.p1 ${OBJECTDIR}/src/app_rtc.p1 ${OBJECTDIR}/src/app_util.p1 ${OBJECTDIR}/src/app_ble.p1 ${OBJECTDIR}/src/app_led.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/drv_tmr.p1.d ${OBJECTDIR}/src/drv_pwm.p1.d ${OBJECTDIR}/src/drv_eeprom.p1.d ${OBJECTDIR}/src/drv_eusart.p1.d ${OBJECTDIR}/src/app_key.p1.d ${OBJECTDIR}/src/app_rtc.p1.d ${OBJECTDIR}/src/app_util.p1.d ${OBJECTDIR}/src/app_ble.p1.d ${OBJECTDIR}/src/app_led.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/drv_tmr.p1 ${OBJECTDIR}/src/drv_pwm.p1 ${OBJECTDIR}/src/drv_eeprom.p1 ${OBJECTDIR}/src/drv_eusart.p1 ${OBJECTDIR}/src/app_key.p1 ${OBJECTDIR}/src/app_rtc.p1 ${OBJECTDIR}/src/app_util.p1 ${OBJECTDIR}/src/app_ble.p1 ${OBJECTDIR}/src/app_led.p1

# Source Files
SOURCEFILES=src/drv_tmr.c src/drv_pwm.c src/drv_eeprom.c src/drv_eusart.c src/app_key.c src/app_rtc.c src/app_util.c src/app_ble.c src/app_led.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/HagenStripIII_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/HagenStripIII_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/HagenStripIII_Pro.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/HagenStripIII_Pro.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/HagenStripIII_Pro.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/HagenStripIII_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/HagenStripIII_Pro.X.${IMAGE_TYPE}.map  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/HagenStripIII_Pro.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
